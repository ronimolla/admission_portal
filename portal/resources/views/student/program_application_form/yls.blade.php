	...
	<div class="page-content" style="background: darkorange">
		<div class="wizard-v4-content">
			<div class="wizard-form">
				...
				<form class="form-register"  method="post" action="{{url('/student/yls/store')}}"  novalidate="novalidate">{{csrf_field()}}
		        	<div id="form-total">
			            ...
			            <section>
							...
							<div class="row g-3">
								...
								<div class="col-md-6">
									...
									<input type="text" class="form-control" id="nid" name="nid" value ="{{old('nid',$student->student_id)}}" readonly>
