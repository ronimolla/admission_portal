        ...
        <div class="" data-simplebar style="height: 100%;">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li class="{{ request()->is('overview') ? 'active' : '' }}" >
                    <a class="sidenav-item-link" href="{{url('/over-view')}}">
                ...
                <li class="">
                    <a class="sidenav-item-link" href="{{url('/students/programs_info')}}">
                        ...
                        <span class="nav-text">Students DB</span> 
                    </a>
                </li>
                ...
                <li class="has-sub {{ request()->is('') || request()->is('') ? 'active' : '' }} ">
                  <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#old"
                    aria-expanded="false" aria-controls="old">
                  ...
                  <ul class="{{ request()->is('') || request()->is('') ? '' : 'collapse' }} " id="old" data-parent="#sidebar-menu">
                    <div class="sub-menu">
                      <li class="{{ request()->is('form_collection') ? 'active' : '' }}">
                        <a class="sidenav-item-link   " href="{{url('forms')}}">
